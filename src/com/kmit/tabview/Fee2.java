...
public class Fee2 extends Activity {
	...
	public void click(View v) {
	   	 switch (v.getId()) {
		      case R.id.imageButton1:
		    	  Intent i1=new Intent(this,PutValues7.class);
		    	  startActivity(i1);
		        break;
		      case R.id.imageButton2:
		    	  Intent i2=new Intent(this,PutValues8.class);
		    	  startActivity(i2);
		        break;
		      case R.id.imageButton3:
		    	  Intent i3=new Intent(this,PutValues9.class);
		    	  startActivity(i3);
			        break;
	...
	{
		Cursor c=db.query("admission", new String[]{"name","roll","average"},null, null, null, null, null);
